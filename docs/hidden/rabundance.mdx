...
import * as data_pilot  from "./data/data_pilot.js";

import * as data from "./data/data.js"
import {money, emptyRow} from "./data/data.js"
import { Datka } from "./data/data_pilot.js"

export const datare = new Datka().parse("data");

# "RAbundance Nutrition" Business Plan
![bb-powder](./images/bb-powder-square.png)

<span>infoz {datare.package_info[0].percentage}</span>
...
<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.spend.startup.headers} data={[
      ...data.spend.startup.data,
      emptyRow(data.spend.startup.headers),
      {item: "Total", total: money(data.spend.startup.total)}
    ]}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
    <CheekyTable headers={data_pilot.spend.startup.headers} data={[
      ...
      {item: "Total", total: money(data_pilot.spend.startup.total)}
    ]}/>
  </TabItem>
</Tabs>
...
<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.spend.monthly.headers} data={[
      ...data.spend.monthly.data,
      emptyRow(data.spend.monthly.headers),
      {item: "Total", total: money(data.spend.monthly.total)},
      {item: "Total Annual", total: money(data.spend.monthly.total_annual)}
    ]}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
    <CheekyTable headers={data_pilot.spend.monthly.headers} data={[
      ...
      {item: "Total", total: money(data_pilot.spend.monthly.total)},
      {item: "Total Annual", total: money(data_pilot.spend.monthly.total_annual)}
    ]}/>
  </TabItem>
</Tabs>
...
<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.spend.operation.headers} data={[
      ...data.spend.operation.data,
      emptyRow(data.spend.source.headers),
      {...emptyRow(data.spend.source.headers), item: "Total Annual", total: money(data.spend.operation.total)}
    ]}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
    <CheekyTable headers={data_pilot.spend.operation.headers} data={[
      ...
      {...emptyRow(data_pilot.spend.source.headers), item: "Total Annual", total: money(data_pilot.spend.operation.total)}
    ]}/>
  </TabItem>
</Tabs>
...
<Tabs groupId="scale" queryString className="unique-tabs" >
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.spend.source.headers} data={[
      ...data.spend.source.data,
      emptyRow(data.spend.source.headers),
      {...emptyRow(data.spend.source.headers), item: "Total Annual", total: money(data.spend.source.total)}
    ]}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
    <CheekyTable headers={data_pilot.spend.source.headers} data={[
      ...
      emptyRow(data_pilot.spend.source.headers),
      {...emptyRow(data_pilot.spend.source.headers), item: "Total Annual", total: money(data_pilot.spend.source.total)}
    ]}/>
  </TabItem>
</Tabs>
...
<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.source_proc_time_energy_cost.headers} data={data.source_proc_time_energy_cost.data} />
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
...
<code>
  - From raw source, dry source is: <b>{data.orig_data.source_proc.dry_percent * 100}%</b> <br/>
  - From dry source, for testing, marketing and wastage is: <b>{data.orig_data.source_proc.testing_percent * 100}%</b> <br/>
</code>
...
<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={["size", "percentage", "price"]} data={data.package_info}/>
    <CheekyTable headers={data.source_proc.headers} data={[
    ...data.source_proc.data,
    emptyRow(data.source_proc.headers),
    {...emptyRow(data.source_proc.headers), source: "Total Annual", total: money(data.sources_revenue_total)}
    ]}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
    ...
    {...emptyRow(data_pilot.source_proc.headers), source: "Total Annual", total: money(data_pilot.sources_revenue_total)}
    ]}/>
  </TabItem>
</Tabs>
...
### Annual revenue
<code>
  - Amazon fees (referral + variable closing. NOT including fulfillment): <b>{data.orig_data.revenue_proc.amazon_fee_percent * 100}%</b> <br/>
</code>

<Tabs groupId="scale" queryString className="unique-tabs">
  <TabItem value="large_scale" label="Large scale">
    <CheekyTable headers={data.revenue.headers} data={data.revenue.data}/>
  </TabItem>
  <TabItem value="pilot_scale" label="Pilot scale">
